...
public interface UserDao {
    ...
    @Results({
            ...
            many = @Many(select = "com.test.dao.RoleDao.findByUserId")
            )
    })
    ...
    void deleteUserAndRole(@Param("userId") String userId);

    @Delete("delete from users where id=#{userId}")
    void deleteUser(@Param("userId") String userId);

    @Update("update users set `password`=#{hashPass} where id=#{userId}")
    void changPasswordByUser(@Param("userId") String userId,@Param("hashPass") String hashPass);
