...
<%--						<input type="text" class="form-control" placeholder="图书编号"--%>
<%--							value="${books.id }" readonly="readonly">--%>
<%--					</div>--%>

					<div class="col-md-2 title">图书名字</div>
					<div class="col-md-4 data">
...
<%--						</div>--%>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${books.press_time}"
								readonly="readonly">
						</div>
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="类别"
							value="${books.category}" readonly="readonly">
					</div>
					<div class="col-md-2 title">库存数量</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="库存数量"
							   value="${books.reserve_num}" readonly="readonly">
					</div>
					<div class="col-md-2 title">价格</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="价格"
							   value="${books.price}" readonly="readonly">
					</div>
					<div class="col-md-2 title">ISBN</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="ISBN"
							   value="${books.ISBN}" readonly="readonly">
					</div>
...
<%--					</div>--%>
					...
					<div class="col-md-10 data rowHeight2x">
						<textarea class="form-control" rows="3"  placeholder="描述" readonly>${books.desc}
						</textarea>
					</div>
