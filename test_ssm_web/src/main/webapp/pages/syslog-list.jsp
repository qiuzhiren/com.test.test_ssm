					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<c:if test="${pageInfo.hasPreviousPage }">
								<li>
									<a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum-1}" rel="external nofollow" aria-label="Previous">
							...
							<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
								<c:if test="${page_Num == pageInfo.pageNum }">
									<li class="active"><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${ page_Num}&size=${pageInfo.pageSize}" rel="external nofollow" >${ page_Num}</a></li>
								</c:if>
								<c:if test="${page_Num != pageInfo.pageNum }">
									<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${ page_Num}" rel="external nofollow" >${ page_Num}</a></li>
								</c:if>
							</c:forEach>
							<c:if test="${pageInfo.hasNextPage }">
								<li>
									<a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum+1}" rel="external nofollow" aria-label="Next">
