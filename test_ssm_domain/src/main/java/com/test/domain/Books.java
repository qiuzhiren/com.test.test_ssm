...
public class Books {
    ...
    public Books(String id, String name, String author, String press, String press_time, String category, Integer reserve_num, Double price, String ISBN, String desc) {
        this.id = id;
        this.name = name;
        this.author = author;
        this.press = press;
